<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <WmsStorageLocationsModal @register="registerModal" @success="handleSuccess"></WmsStorageLocationsModal>
  </div>
</template>
...
<script lang="ts" name="warehouse-wmsStorageLocations" setup>
  ...
  import WmsStorageLocationsModal from './components/WmsStorageLocationsModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './WmsStorageLocations.data';
