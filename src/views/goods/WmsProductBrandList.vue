<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <WmsProductBrandModal @register="registerModal" @success="handleSuccess"></WmsProductBrandModal>
  </div>
</template>

<script lang="ts" name="goods-wmsProductBrand" setup>
  import {ref, reactive, computed, unref} from 'vue';
  import {BasicTable, useTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import WmsProductBrandModal from './components/WmsProductBrandModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './WmsProductBrand.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './WmsProductBrand.api';
       ...
       return [
         {
           ...
           auth: 'goods:wms_product_brand:edit'
         }
       ]
   }
     /**
       ...
       return [
         {
           ...
           auth: 'goods:wms_product_brand:delete'
         }
       ]
   }
